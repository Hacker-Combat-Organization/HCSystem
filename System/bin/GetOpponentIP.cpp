...
int main(int argc,char *argv[]){
  ...
  cout << "=================" << endl;
  cout << "|               |" << endl;
  cout << "| GetOpponentIP |" << endl;
  cout << "|               |" << endl;
  cout << "================" << endl;
  cout << "Get Opponent ID Usage: GetOpponentIP" << endl << endl;
  if (system(NULL)) puts ("Result:");
    else exit (EXIT_FAILURE);
  system ("export HC=$(echo $PWD) ; cat $(echo $HC)/node/playerserver/opp.ip");
  cout << endl << "----------" << endl;
  return 0;
}
